    ...
    <style>
        ...
        * {
        ...
        .proj-image-wrapper {
            ...
            align-items: center;
            height: 100%;
            min-width: 40vw; /* Placeholder width so the strip isn't squished before images load */
        }

        .proj-loading-placeholder {
            position: absolute;
            display: flex;
            flex-direction: column;
            align-items: center;
...
<body>
    ...
    <script>
        ...
        IMAGES.forEach((img, idx) => {
            ...
            imageWrapper.className = 'proj-image-wrapper';
            
            const placeholder = document.createElement('div');
            placeholder.className = 'proj-loading-placeholder';
            placeholder.innerHTML = `<div class="spinner"></div><div class="progress-text">LOADING...</div>`;
            ...
            filmContainer.appendChild(imageWrapper);
