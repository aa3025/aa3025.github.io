...
def generate(slide_num, model="gemini-2.5-flash-preview-tts", 
             ...
             spk2_name="Jack", spk2_voice="Orus",
             preamble="Read aloud in a warm, welcoming tone:",
...
if __name__ == "__main__":
    ...
    spk2_voice = sys.argv[6] if len(sys.argv) > 6 else "Orus"
    preamble = sys.argv[7] if len(sys.argv) > 7 else "Read aloud in a warm, welcoming tone:"
